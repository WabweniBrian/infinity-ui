  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white px-4 py-10 dark:bg-gray-950">
      <div className={`w-full ${isDarkMode ? "dark" : ""} ${className}`}>
        <div className="mx-auto max-w-7xl overflow-hidden rounded-xl bg-white bg-opacity-95 shadow-xl backdrop-blur-sm transition-all duration-300 dark:bg-gray-900 dark:bg-opacity-90">
          {/* Header */}
                    ...
                    <AnimatePresence>
                      {isFilterMenuOpen && (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -10 }}
                          className="absolute left-0 z-10 mt-2 w-64 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-gray-800 sm:left-auto sm:right-0"
                        >
                          <div className="p-2">
                                ...
                                .map((column) => (
                                  <div key={column.id} className="px-3 py-2">
                                    ...
                                    <input
                                      ...
                                      className="w-full rounded-md border border-gray-300 bg-white px-2 py-1 text-sm text-gray-700 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300"
            ...
            {search && (
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-md border border-gray-300 bg-white py-2 pl-10 pr-3 leading-5 text-gray-700 placeholder-gray-400 transition-colors duration-200 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-500 sm:text-sm"
                  placeholder="Search..."
                />
                {searchQuery && (
                  <button
                      ...
                      <div className="flex items-center">
                        ...
                        {column.sortable !== false && (
                          <span className="ml-2">
                            {sortBy?.id === column.id ? (
                              sortBy.desc ? (
                                <SortDesc className="h-4 w-4 text-violet-500 dark:text-violet-400" />
                              ) : (
                                <SortAsc className="h-4 w-4 text-violet-500 dark:text-violet-400" />
                              )
                            ) : (
                              <div className="h-4 w-4 text-transparent">•</div>
                            )}
                          </span>
                        )}
                      </div>
                ...
                <div className="flex items-center">
                  <div className="mr-4">
                    ...
                    <select
                      ...
                      className="block w-full rounded-md border-gray-300 bg-white py-2 pl-3 pr-10 text-base text-gray-700 focus:border-violet-500 focus:outline-none focus:ring-violet-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 sm:text-sm"
                    >
                          ...
                          <button
                            ...
                            className={`relative inline-flex items-center border px-4 py-2 text-sm font-medium ${
                              currentPage === pageNumber
                                ? "z-10 border-violet-500 bg-gradient-to-r from-violet-500 to-cyan-500 text-white dark:border-cyan-600"
