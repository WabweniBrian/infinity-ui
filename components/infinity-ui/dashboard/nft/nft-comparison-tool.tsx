...
import { availableNFTs, NFTData } from "@/data/comparison-nfts";

interface NFTComparisonToolProps {
  onClose?: () => void;
}

const NFTComparisonTool = ({ onClose }: NFTComparisonToolProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 p-4">
      <div className="mx-auto w-full max-w-7xl overflow-hidden rounded-2xl border border-slate-800 bg-slate-900">
        {/* Header */}
                        ...
                        <tbody>
                          {getAllTraitTypes().map((traitType) => (
                            ...
                            >
                              ...
                              {selectedNFTs.map((nft) => {
                                const traitValue = getTraitValue(
                                  nft,
                                  traitType,
                                );
