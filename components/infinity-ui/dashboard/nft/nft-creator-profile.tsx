...
const creatorData = {
  ...
  coverImage:
    "https://ldw366cauu.ufs.sh/f/X5rZLOaE9ypowNsYN9UuGsmZFnW0VycwkvQUeR4Mg7aL5o1x",
  bio: "Digital artist specializing in abstract NFT art. Creating unique digital collectibles since 2020. My work explores the intersection of technology and traditional art forms, bringing a unique perspective to the NFT space.",
  isVerified: true,
  followers: 12540,
  following: 342,
  totalSales: "156",
  totalVolume: "423.5 ETH",
  ...
  collections: [
    ...
    },
    {
      ...
      name: "Digital Dreams",
      image:
        "https://ldw366cauu.ufs.sh/f/X5rZLOaE9yposEqJCaPqynLtKbkXomjxFR9Z4NvPu2gCVl81",
      itemCount: 75,
      floorPrice: "1.8",
    },
  ],
...
const NFTCreatorProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 p-4">
      <div className="mx-auto w-full max-w-6xl overflow-hidden rounded-2xl border border-slate-800 bg-slate-900">
