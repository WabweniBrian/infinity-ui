...
export default function FeatureComparisonPricing() {
  ...
  return (
    <section className="bg-slate-50 py-24 dark:bg-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full overflow-x-auto rounded-xl bg-white shadow-lg dark:bg-slate-800">
          <div className="min-w-[800px]">
            ...
            <div className="grid grid-cols-4 border-b border-slate-200 dark:border-slate-700">
              ...
              <div className="border-l border-slate-200 p-6 dark:border-slate-700">
                <div className="text-center">
                  ...
                  <button className="w-full rounded-lg bg-slate-100 px-4 py-2 font-medium transition-colors hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600">
                    Get started
                  </button>
                </div>
              </div>

              <div className="relative border-l border-slate-200 bg-violet-50 p-6 dark:border-slate-700 dark:bg-violet-900/20">
                <div className="text-center">
                  <div className="absolute left-1/2 top-0 -translate-x-1/2 transform rounded-b-lg bg-violet-600 px-3 py-1 text-xs font-bold text-white">
                    MOST POPULAR
                  </div>
            ...
            {featureCategories.map((category, categoryIndex) => (
              ...
              >
                <motion.div
                  className="grid cursor-pointer grid-cols-4 hover:bg-slate-50 dark:hover:bg-slate-700/50"
                ...
                >
                  ...
                  <div className="border-l border-slate-200 bg-violet-50 p-4 dark:border-slate-700 dark:bg-violet-900/20"></div>
                  <div className="border-l border-slate-200 p-4 dark:border-slate-700"></div>
                </motion.div>
                ...
                {isExpanded(category.name) &&
                  category.features.map((feature, featureIndex) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center border-l border-slate-200 bg-violet-50 p-4 dark:border-slate-700 dark:bg-violet-900/20">
