  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -bottom-10 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-2 pt-6 text-center text-sm font-medium text-white opacity-0 transition-all duration-300 group-hover:bottom-0 group-hover:opacity-100 dark:from-black/90"
      >
        {partner.name}
      </motion.div>
    </motion.div>
