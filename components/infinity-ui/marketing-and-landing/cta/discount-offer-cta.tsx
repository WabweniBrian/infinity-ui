          ...
          <div className="relative overflow-hidden p-8 sm:p-12">
            ...
            <div className="relative">
              ...
              <motion.h2 variants={itemVariants} className="mb-4 text-3xl font-bold text-gray-900 sm:text-4xl">
                Get <span className="text-purple-600">40% OFF</span> on All Premium Templates
              </motion.h2>

              <motion.p variants={itemVariants} className="mb-6 max-w-lg text-gray-600">
                Limited time offer! Grab our entire collection of premium website templates at an unbeatable price.
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap gap-4">
                ...
                <motion.div whileHover={{ scale: 1.03 }} className="flex items-center gap-2 text-sm text-gray-600">
                  <span>Use code:</span>
                  <span className="rounded-md bg-gray-100 px-2 py-1 font-mono font-bold text-purple-600">FLASH40</span>
                </motion.div>
              </motion.div>
            </div>
          </div>
