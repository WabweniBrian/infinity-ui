...
import { ArrowRight, BookOpen, GraduationCap, Mail, User, Lock } from "lucide-react"
import Image from "next/image"

const EducationSignUp = () => {
      ...
      <div className="flex w-full items-center justify-center p-8 md:w-1/2 md:p-12">
        ...
        >
          <div className="mb-8">
            ...
            <h2 className="mb-2 text-2xl font-bold text-gray-900">Join EduLearn today!</h2>
            ...
            <div className="mb-6 flex rounded-full border border-gray-200 bg-white p-1">
              <button
                ...
                className={`flex-1 rounded-full py-2 text-sm font-medium transition-all ${
                  userType === "student" ? "bg-orange-500 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                Student
              </button>
              <button
                ...
                className={`flex-1 rounded-full py-2 text-sm font-medium transition-all ${
                  userType === "teacher" ? "bg-orange-500 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                Teacher
              </button>
              <button
                ...
                className={`flex-1 rounded-full py-2 text-sm font-medium transition-all ${
                  userType === "parent" ? "bg-orange-500 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                Parent
              </button>
          ...
          <div className="mt-8">
            <p className="text-center text-sm text-gray-600">
              ...
              <Link href="#" className="font-medium text-orange-600 transition-colors hover:text-orange-500">
                Sign in
              </Link>
            </p>
          </div>
        ...
        >
          <div className="mb-8">
            ...
            <p className="mb-6 text-orange-100">
              Join thousands of students worldwide who are transforming their education with EduLearn.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="mb-1 text-lg font-medium text-white">Interactive courses</h3>
                <p className="text-sm text-orange-100">
                  Engage with interactive content designed to make learning fun and effective.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="mb-1 text-lg font-medium text-white">Learn at your own pace</h3>
                <p className="text-sm text-orange-100">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="mb-1 text-lg font-medium text-white">Expert instructors</h3>
                <p className="text-sm text-orange-100">
                  Learn from industry professionals and academic experts in every field.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 border-t border-orange-400/30 pt-8">
            <div className="flex items-center">
              ...
              <p className="text-sm text-orange-100">
                Join <span className="font-medium text-white">10,000+</span> students already learning with us
              </p>
            </div>
          </div>
        </motion.div>
...
export default EducationSignUp
