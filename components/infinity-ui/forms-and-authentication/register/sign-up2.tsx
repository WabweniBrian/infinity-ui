        ...
        <div className="relative">
          ...
          >
            ...
            <div className="px-8 pb-6 pt-8">
              ...
              <p className="mt-2 text-center text-gray-500">Sign up to get started with our platform</p>
            </div>
            ...
            <div className="p-8 pt-0">
              <form className="space-y-5">
                ...
                <div className="flex items-center">
                  <motion.button
                    ...
                    className={`flex h-5 w-5 items-center justify-center rounded border ${agreeTerms ? "border-teal-500 bg-teal-500" : "border-gray-300"}`}
                    whileTap={{ scale: 0.9 }}
                  >
              ...
              <p className="mt-8 text-center text-sm text-gray-500">
                ...
                <Link href="#" className="font-medium text-teal-600 transition-colors hover:text-teal-500">
                  Sign in
                </Link>
              </p>
            </div>
