...
import { ArrowRight, Globe, Lock, Map, Plane, Sunrise, User } from "lucide-react"
      ...
      <div className="flex w-full items-center justify-center p-8 md:w-1/2 md:p-12">
        ...
        >
          <div className="mb-8">
            ...
            <h2 className="mb-2 text-2xl font-bold text-gray-900">Start your journey</h2>
            <p className="text-gray-600">Create an account to plan your next adventure</p>
          </div>
          ...
          <div className="mt-8">
            <p className="text-center text-sm text-gray-600">
              ...
              <Link href="#" className="font-medium text-sky-600 transition-colors hover:text-sky-500">
                Sign in
              </Link>
            </p>
          </div>
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-gradient-to-br from-sky-400 to-blue-500 p-12 md:block">
        ...
        >
          <div className="mb-8">
            ...
            <h2 className="mb-4 text-3xl font-bold text-white">Discover the world with us</h2>
            <p className="mb-6 text-sky-100">
              Join our community of travelers and unlock exclusive benefits for your next adventure.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="mb-1 text-lg font-medium text-white">Exclusive deals</h3>
                <p className="text-sm text-sky-100">Get access to member-only discounts and offers.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="mb-1 text-lg font-medium text-white">Personalized recommendations</h3>
                <p className="text-sm text-sky-100">Discover destinations tailored to your preferences.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="mb-1 text-lg font-medium text-white">Travel community</h3>
                <p className="text-sm text-sky-100">Connect with fellow travelers and share experiences.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 border-t border-sky-400/30 pt-8">
            <div className="flex items-center">
              ...
              <p className="text-sm text-sky-100">
                Join <span className="font-medium text-white">2M+</span> travelers worldwide
              </p>
            </div>
          </div>
        </motion.div>
