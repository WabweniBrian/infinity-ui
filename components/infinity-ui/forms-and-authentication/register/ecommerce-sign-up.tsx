...
import { ArrowRight, CreditCard, Package, ShoppingBag, Truck, User } from "lucide-react"
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-gradient-to-br from-rose-500 to-pink-600 p-12 md:block">
        ...
        >
          <div className="mb-8">
            ...
            <h2 className="mb-4 text-3xl font-bold text-white">Join our shopping community</h2>
            <p className="mb-8 text-rose-100">
              Create an account to start shopping, save your favorites, and get personalized recommendations.
            </p>
            ...
            <div className="mb-8 grid grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-sm text-rose-100">Get your items delivered in 24 hours</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-rose-100">Multiple payment options available</p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="mt-auto border-t border-rose-400/30 pt-8">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium text-white">Free shipping on your first order</p>
      ...
      <div className="flex w-full items-center justify-center p-8 md:w-1/2 md:p-12">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Join ShopHub to start shopping</p>
          </div>
          ...
          <form className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 pl-10 pr-4 py-3 outline-none transition-all duration-200 focus:border-transparent focus:ring-2 focus:ring-rose-500"
            ...
            <div className="flex items-center">
              <motion.button
                ...
                className={`flex h-5 w-5 items-center justify-center rounded border ${agreeTerms ? "border-rose-500 bg-rose-500" : "border-gray-300"}`}
                whileTap={{ scale: 0.9 }}
              >
                {agreeTerms && (
