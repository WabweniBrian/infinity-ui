...
import { ArrowRight, ChevronDown, Lock, Shield, User } from "lucide-react";
            ...
            <form className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <Link
                    href="#"
                    className="text-sm text-emerald-600 transition-colors hover:text-emerald-500"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              {showSecurityTips && (
                ...
                >
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="mr-2 h-5 w-5 text-emerald-600">•</span>
                      SecureBank will never ask for your full password or PIN
                    </li>
                  </ul>
                </motion.div>
              )}
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-100">
                    24/7 monitoring to detect and prevent unauthorized
                    transactions.
                  </p>
                </div>
              </div>
